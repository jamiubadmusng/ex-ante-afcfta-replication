...
# full bilateral trade data from ITPD-E-R02.
...
# Save results
saveRDS(dt, "02_output/rds/full_static_all_agri.rds")
...
saveRDS(imr_dt, "02_output/rds/imrs_all_agri.rds")
...
saveRDS(all_indexes, "02_output/rds/all_indexes_geppml_agri.rds")
...
saveRDS(all_indexes_with_row, "02_output/rds/all_indexes_with_row_geppml_agri.rds")
...
# Save results
saveRDS(dt, "02_output/rds/full_static_all_manu.rds")
...
imr_dt[, imr_full_ch := (imr_full - imr_bsln) / imr_bsln * 100]
imr_dt[, imr_cndl_ch := (imr_cndl - imr_bsln) / imr_bsln * 100]
saveRDS(imr_dt, "02_output/rds/imrs_all_manu.rds")
...
# Combine OMR and IMR indexes
all_indexes <- merge(omr_dt, imr_dt, by = "country", all = TRUE)
saveRDS(all_indexes, "02_output/rds/all_indexes_geppml_manu.rds")
...
# Save the aggregated data
saveRDS(all_indexes_with_row, "02_output/rds/all_indexes_with_row_geppml_manu.rds")
...
# Save results
saveRDS(dt, "02_output/rds/full_static_all_mine.rds")
...
imr_dt[, imr_full_ch := (imr_full - imr_bsln) / imr_bsln * 100]
imr_dt[, imr_cndl_ch := (imr_cndl - imr_bsln) / imr_bsln * 100]
saveRDS(imr_dt, "02_output/rds/imrs_all_mine.rds")
...
# Combine OMR and IMR indexes
all_indexes <- merge(omr_dt, imr_dt, by = "country", all = TRUE)
saveRDS(all_indexes, "02_output/rds/all_indexes_geppml_mine.rds")
...
# Save the aggregated data
saveRDS(all_indexes_with_row, "02_output/rds/all_indexes_with_row_geppml_mine.rds")
...
# Save results
saveRDS(dt, "02_output/rds/full_static_all_serv.rds")
...
imr_dt[, imr_full_ch := (imr_full - imr_bsln) / imr_bsln * 100]
imr_dt[, imr_cndl_ch := (imr_cndl - imr_bsln) / imr_bsln * 100]
saveRDS(imr_dt, "02_output/rds/imrs_all_serv.rds")
...
# Combine OMR and IMR indexes
all_indexes <- merge(omr_dt, imr_dt, by = "country", all = TRUE)
saveRDS(all_indexes, "02_output/rds/all_indexes_geppml_serv.rds")
...
# Save the aggregated data
saveRDS(all_indexes_with_row, "02_output/rds/all_indexes_with_row_geppml_serv.rds")
...
################################################################################
# Section 5: Combine Welfare Estimates for all the Sectors for full trade data--
################################################################################
...
saveRDS(combined_welfare, "combined_welfare_effects_full_data.rds")
write.csv(combined_welfare, "C:/Users/muham/AfCFTA_UNU_CRIS/02_output/csv/combined_welfare_effects_full_data.csv", row.names = FALSE)
...
writeLines(latex_code_with_note, "C:/Users/muham/AfCFTA_UNU_CRIS/02_output/tables/welfare_effects_table_full_data.tex")

# Print completion message
cat("\nAnalysis completed. Results saved to:\n")
cat("1. combined_welfare_effects_full_data.rds (R data format)\n")
cat("2. combined_welfare_effects_full_data.csv (CSV format)\n")
cat("3. welfare_effects_table_full_data.tex (LaTeX table)\n")
